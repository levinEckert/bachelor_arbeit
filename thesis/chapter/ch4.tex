...
gemäß \hyperlink{req:F-03}{F-03} getrennt prüfbar und gemäß \hyperlink{req:Q-01}{Q-01} als getrennte
...
Für die spektrale Auswertung des demodulierten Signals wird das
\acrshort{SES} gewählt. Die Wahl beruht auf den in
Abschnitt~\ref{sec:huellkurvenanalyse} erläuterten Vorteilen der quadrierten
gegenüber der nicht quadrierten Hüllkurve.
...
Gemäß Anforderung \hyperlink{req:E-03}{E-03} im Absatz
