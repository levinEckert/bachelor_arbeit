...
\newglossaryentry{quadraturkomponente}{
    name={Quadraturkomponente},
    description={Durch Hilbert-Transformation aus einem reellen Signal
    gebildete Komponente. Sie bildet den Imaginärteil des analytischen
    Signals. Positive Frequenzanteile sind gegenüber dem Ausgangssignal
    um $-90^\circ$ und negative um $+90^\circ$ in der Phase verschoben
    \cite[S.~740, Abschn.~3, Gl.~(4); S.~747, Abschn.~6]
    {feldmanHilbertTransformVibration2011}.
    \hyperlink{begriff:quadraturkomponente}{Zur Textstelle in
    Abschnitt~\ref*{sec:huellkurvenanalyse}}.}
}
